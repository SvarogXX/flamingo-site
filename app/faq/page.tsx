...
const faqData: FAQ[] = [
  ...
  },
  {
    ...
    answer: "Реєстрація займає менше хвилини — перейдіть на сторінку реєстрації, введіть email та створіть пароль. Якщо забули пароль, натисніть «Забули пароль?» на сторінці входу та слідуйте інструкціям, які надійдуть на ваш email. Якщо виникли проблеми, напишіть нам на support@flamingo-crm.com",
  },
  {
    id: "4",
    category: "Реєстрація та доступ",
  ...
  // Технічні питання
  {
    ...
    answer: "Спочатку перевірте налаштування сповіщень в «Профіль» → «Сповіщення» та переконайтеся, що каналі увімкнені. Якщо сповіщення через Telegram, перевірте, що ви підписані на бота. У разі проблем очистіть кеш браузера або спробуйте інший браузер. Якщо проблема залишається, напишіть support@flamingo-crm.com",
  },
  {
    id: "15",
    category: "Технічні питання",
  ...
  },
  {
    ...
    answer: "Ми активно слухаємо ваші ідеї! Напишіть про бажану функцію на support@flamingo-crm.com або залийте issue на GitHub. Всі популярні пропозиції розглядаються в першу чергу команди розробників.",
  },
  {
    id: "20",
    category: "Інше",
    question: "Чи є API для інтеграцій?",
    answer: "API знаходиться в розробці. На даний момент доступні базові вебгуки для автоматизації. Повна документація API буде опублікована найближчими місяцями. Якщо вам потрібна певна інтеграція, напишіть на support@flamingo-crm.com та ми розглянемо вашу заявку.",
  },
];
      ...
      <section className="relative py-16 lg:py-20 bg-gradient-to-t from-purple-900/10 to-[#0a0a0f] border-t border-white/10">
        ...
        >
          ...
          <p className="text-gray-300 text-lg mb-8">
            Напишіть нам на{" "}
            <motion.a
              href="mailto:support@flamingo-crm.com"
